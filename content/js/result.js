const scoreTexts = {
    ...
    bishop: {
        ...
        detail: [
            '빈칸이 보이면 어디든 전진~ 제한없이 빈칸이 있으며 몇 칸이라도 이동 가능한 <span>비숍</span>처럼 빈틈을 채우려 노력하는 여기가 바로 엄마표영어 맛집! 망설이지 마요~ 지금 당장 <span>비숍</span>처럼 전진해보세요!'
        ]
    },
    king: {
    ...
    rook: {
        ...
        detail: [
            '체스판 위, 가는 길에 내 편이 있으면 특히 강력해지는 룩처럼 당신을 이끌어주는 엄마표영어 코치가 있다면 더 높이 나아갈 가능성이 넘치는 당신! 눈부신 당신이여, 여기까지 오느라 수고 많으셨습니다! 코치의 도움으로 파워업하면 엄마표영어 신의 경지가 눈앞에!'
        ]
    },
    queen: {
...
const resultTexts = {
    ...
    highScore: {
        ...
        textDetail : [
            ...
            `지금의 경험을 잘 기억하고 기록해보세요! 그리고… 당신의 엄마표영어 파워에 전문성을 더해보세요! 이후 엄마표영어 전문가로 거듭날 수 있는 잠재력을 이대로 가만히 둘 수 없죠~~!!`,
            `<p class="result__recommend">[원데이 리터러시 스타트]를 추천합니다. 당신은 미래의 멋진 엄마표영어 전문가가 될 수 있어요!</p>`,
        ]
    }
}
