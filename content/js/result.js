const scoreTexts = {
    ...
    king: {
        ...
        detail: [
            '두근두근, 엄마표영어 고수의 기운이 느껴지는 당신!',
            '체스판 위에서 어느 방향으로든 한 칸씩 전진할 수 있는 <span>킹</span>처럼 ‘1일 1 작은 목표 성취’ 공식을 추천합니다!',
...
const resultTexts = {
    understanding: {
        textResult : [
            '코칭파워 업! <span>[아이에 대한 이해]</span>',
        ],
        textDetail : [
            `
            엄마표영어 파워를 충전하기 위해 당신에게 필요한 것은 <span>아이에 대한 이해</span>입니다. 
            ...
            `,
            `
            <p class="result__recommend"><span>원데이 리터러시 스타트</span>를 추천합니다. 아이의 성향과 성격 특성에 맞는 알맞은 영어 학습 방법을 확인할 수 있어요!</p>
            `
        ]
    },
    environment: {
        textResult : [
            '코칭파워 업! <span>[지지적인 엄마표영어 환경]</span>'
        ],
        textDetail : [
            `엄마표영어 파워를 충전하기 위해 당신에게 필요한 것은 <span>지지적인 엄마표영어 환경</span>입니다.`,
            `성공적인 엄마표영어를 위해 중요한 것은 규칙적인 시간, 손을 덜어줄 가족과 지인, 그리고 무엇보다 전문가의 도움입니다. 즉, 엄마표영어를 지속할 수 있도록 <span>엄마표영어 환경</span> 조성이 우선되어야 하죠.`,
            ...
            `<p class="result__recommend"><span>영어책읽기 습관만들기</span>를 추천합니다. 혼자가 아니라 목표가 같은 부모들과 함께 전문가의 코칭을 받으며 엄마표영어에 도전해보세요!</p>`,
        ],
    },
    executive: {
        textResult : [
            '코칭파워 업! <span>[엄마표영어 실행력]</span>'
        ],
        textDetail : [
            `엄마표영어 파워를 충전하기 위해 당신에게 필요한 것은 <span>엄마표영어 실행력</span>입니다.`,
    ...
    skil: {
        textResult : [
            '코칭파워 업! <span>[엄마표영어 기술]</span>'
        ],
        textDetail : [
            `
            엄마표영어 파워를 충전하기 위해 당신에게 필요한 것은 <span>엄마표영어 기술</span>입니다. 
            ...
            `<p class="result__recommend"><span>원데이 리터러시 스타트</span>와 <span>영어책읽기 습관만들기</span>를 추천합니다. 영어책을 읽어주며 어떻게 아이의 영어를 발달시킬 수 있는지 배울 수 있어요!</p>`,
        ]
    },
    efficacy: {
        
        textResult : [
            '코칭파워 업! <span>[엄마표영어 자기효능감]</span>',
        ],
        textDetail : [
            `엄마표영어 파워를 충전하기 위해 당신에게 필요한 것은 <span>엄마표영어 자기효능감</span>입니다. <span>엄마표영어 자기효능감</span>이란 엄마표영어를 적절하게 잘 할 수 있다는 기대와 신념을 말합니다.`,
            `<span>자기효능감</span>을 키우기 위해서는 작은 목표 하나를 성취해보는 것이 중요합니다. 말로만 하는 것이 아니라 작지만 구체적인 목표를 세우고 실제로 성취하는 경험을 갖는 것이 <span>자기효능감</span>에 영향을 미칩니다. 당신이 꿈꾸는 큰 목표와 관련된 작은 목표들을 세우고 지금 바로 실천해보세요! 그리고 그 작은 목표들을 성취할 때마다 본인의 노력에 보상해주세요.“칭찬은 고래도 춤추게 만든다”라는 말이 있죠? 노력에 대한 보상은 당신을 춤추게 만들고, 당신은 다음의 목표를 향해 한 걸음 더 나아가게 될 거예요!`,
            `<p class="result__recommend"><span>리드 투 미 맘</span>과 <span>원데이 리터러시 스타트</span>를 추천합니다. 영어책에 나오는 표현들을 따라읽는 연습부터 시작해보세요. 영어로 유창하게 낭독하는 자신을 발견하며 성취감이 Up! Up! Up! 될 거예요.</p>`,
        ]
    },
    sameScore: {
        textResult : [
            '코칭파워 업! <span>[2% 부족한 팔방미인]</span>',
        ],
        textDetail : [
            `당신은 엄마표영어를 하기 위해 필요한 요인들을 모두 비슷한 수준으로 갖추고 있는 <span>팔방미인</span>! 그런데.. 아쉽게도 모두 2% 부족하네.. 모든 요인들을 조금씩 더 보완하면 좋지만 아이가 만3~6세에 해당한다면 가장 먼저 <span>아이에 대한 이해</span>를 넓혀보는 것은 어떨까요?`,
            `엄마표영어는 애착 관계가 형성된 부모가 자신의 자녀에게 직접! 영어를 가르친다는 점에서 다른 교육 방법과 차별되는 강점을 지닙니다.`,
            `부모는 이미 아이의 취향과 성향을 이해하고 있기 때문에, 아이가 학습 시 어떻게 느낄지 고려하며 아이에게 딱 맞는 학습 방법과 학습 내용을 선택할 수 있습니다. 이때문에 아이는 같은 내용을 배우더라도 자신의 마음과 행동을 잘 이해해주는 부모와 학습할 때 새로운 내용에 더욱 개방적인 태도를 보이게 된답니다.`,
            `<span>아이에 대한 이해</span>를 넓히기 위해 오늘부터 아이의 행동을 주의 깊게 관찰하고 전문적인 테스트를 통해 아이의 성격 특성을 파악해보세요. 지금보다 더 눈부신 우리 아이의 성장을 보게 될 거예요!`,
            `<p class="result__recommend"><span>원데이 리터러시 스타트</span>를 추천합니다. 아이의 성향과 성격 특성에 맞는 알맞은 영어 학습 방법을 확인할 수 있어요!</p>`
        ]
    },
    highScore: {
        textResult : [
            '완벽 그 자체!',
            '<span>[엄마표영어 신의 경지]</span>',
        ],
        textDetail : [
            `CHEERS!!! 당신을 <span>엄마표영어 신의 경지</span>로 인정!!!`,
            ...
            `<p class="result__recommend"><span>원데이 리터러시 스타트</span>를 추천합니다. 당신은 미래의 멋진 엄마표영어 전문가가 될 수 있어요!</p>`,
        ]
    }
}
