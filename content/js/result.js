...
const resultTexts = {
    understanding: {
        ...
        textDetail : [
            ...
            `,
            `
            <p class="result__recommend">원데이 리터러시 스타트를 추천합니다. 아이의 성향과 성격 특성에 맞는 알맞은 영어 학습 방법을 확인할 수 있어요!</p>
            `
        ]
    },
    environment: {
        ...
        textDetail : [
            ...
            `<p class="result__recommend">영어책읽기 습관만들기를 추천합니다. 혼자가 아니라 목표가 같은 부모들과 함께 전문가의 코칭을 받으며 엄마표영어에 도전해보세요!</p>`,
        ],
    },
    executive: {
        textResult : [
    ...
    skil: {
        ...
        textDetail : [
            ...
            `<p class="result__recommend">원데이 리터러시 스타트와 영어책읽기 습관만들기를 추천합니다. 영어책을 읽어주며 어떻게 아이의 영어를 발달시킬 수 있는지 배울 수 있어요!</p>`,
        ]
    },
    efficacy: {
        ...
        textDetail : [
            ...
            `<p class="result__recommend"리드 투 미 맘과 원데이 리터러시 스타트를 추천합니다. 영어책에 나오는 표현들을 따라읽는 연습부터 시작해보세요. 영어로 유창하게 낭독하는 자신을 발견하며 성취감이 Up! Up! Up! 될 거예요.</p>`,
        ]
    },
    sameScore: {
        textResult : [
    ...
    highScore: {
        ...
        textDetail : [
            ...
            `<p class="result__recommend">원데이 리터러시 스타트를 추천합니다. 당신은 미래의 멋진 엄마표영어 전문가가 될 수 있어요!</p>`,
        ]
    }
}
