...
const serveyQuestion = {
    environment: [
        //환경
        '나는 규칙적인 시간을 내어 <br class="mobile">엄마표영어를 할 수 있다.',
    ...
    understanding: [
        ...
        '나는 아이의 여러 특성 및 성향을 세심하게 파악하여 그에 맞추어 엄마표영어를 하기 위한 태도를 보인다.',
    ],
    executive:[
        //실행력
    ...
    skil:[
        //기술
        '나는 아이에게 알맞은 교재나 영어책을 <br class="mobile">고를 수 있다.',
        '우리 아이의 영어책은 내가 읽고 충분히 이해할 수 있다.',
        '아이에게 영어책을 읽어줄 때, 나는 간단한 영어로 질문을 할 수 있다.',
        '나는 기본적인 영어 단어를 <br class="mobile">소리내어 잘 읽을 수 있다.',
    ],
    efficacy:[
        //자기효능감
        '나는 매체를 통해 배우는 엄마표영어 <br class="mobile">교육 내용을 잘 이해한다.',
